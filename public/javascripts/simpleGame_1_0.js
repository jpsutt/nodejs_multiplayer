...
//variable holding key being pressed
    ...
    function Sprite(t_width, t_height, t_cwidth, t_cheight, t_x, t_y, t_dx, t_dy, t_imgAngle, t_moveAngle, t_speed) {
       ...
       // this.context = this.canvas.getContext("2d");
        ...
        this.cHeight = t_cwidth;
        this.cWidth = t_cheight;
        this.x = t_x;
        this.y = t_y;
        this.dx = t_dx;
        this.dy = t_dy;
        this.imgAngle = t_imgAngle;
        this.moveAngle = t_moveAngle;
        this.speed = t_speed;
        this.camera = false;
        this.visible = true;
    ...
    function Scene() {
        ...
        this.setSizePos = function (width, height, top, left) {
...
//Boundary action constants
    ...
    exports.Accel = Accel;
    exports.Timer = Timer;
    exports.localUpdate = localUpdate;
    exports.GameButton = GameButton;


})(typeof exports === 'undefined'? this['simpleGame_1_0.js']={}: exports);